...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, FaturamentoPedidoProto.FaturamentoDoPedido> consumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<>(
                ...
                new ProtoBufDeserializer<>(FaturamentoPedidoProto.FaturamentoDoPedido.parser())
        );
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, FaturamentoPedidoProto.FaturamentoDoPedido> concurrentKafkaListenerContainerFactory() {
